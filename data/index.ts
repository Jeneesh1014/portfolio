...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently Advancing My Expertise in Software Development",
...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Teaching Data Structures and Algorithms to college students for a year, covering fundamental concepts and problem-solving techniques.",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
];
